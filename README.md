...
- Custom domain: plaiddash.wzkeji.cn, managed by the owner through Aliyun DNS.
- DNS: plaiddash CNAME yp27.github.io, default route, TTL 10 minutes.
...
Edit index.html and styles.css, commit, and push main. GitHub Pages publishes automatically. Verify the root page, /support/ and /privacy/ pages, styles.css, and HTTPS after updates.
